...
| 美股 | 美股交易日 **16:05**（`America/New_York`） | 收盤後 5 分鐘寫入；Cloud Scheduler 自動處理夏令／冬令 |
| 加密 | 不適用「收盤」 | 見需求 5 |
...
└───────────────────────────────┬─────────────────────────────────────────┘
 ...
 │ tracked only │      │ 美 16:05      │       │ tracked crypto│
 │ tw / us      │      │ + 匯率        │       │               │
 └──────┬───────┘      └──────┬───────┘       └──────┬───────┘
        │                       │                       │
        └───────────────────────┴───────────────────────┘
...
| **收盤價** | 美股交易日 **16:05** | 美股 | `America/New_York`（自動處理夏令／冬令） | tracked 美股 |
...
| 現狀 | 目標 |
|------|------|
| 股價主要靠 GitHub 每日低頻更新 | 盤中 10～15 分 + 美股收盤後 16:05 一次 + 加密每小時 |
