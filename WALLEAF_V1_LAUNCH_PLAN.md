...
- [x] Free：5 檔、3 帳戶、單一投資市場、無備份／還原／匯入／Face ID
- [x] Plus：全解鎖
...
| 第 6 檔 distinct 持股 | 新增買入／匯入造成新標的前 |
...
- [ ] **允許賣出**，但 UI 強制：
  ...
  - [ ] 隱藏或停用部分賣出、百分比賣出
  - [ ] 賣單文案：「合規清倉須一次賣出全部持股」
- [ ] 混合市場：須賣到 ≤5 檔且**單一市場**；必要時引導「請先賣清某市場全部持股」
...
- [ ] 試用中：備份、匯入、Face ID、超過 5 檔
- [ ] 取消訂閱／試用結束：Plus 關閉、Face ID 關、備份導向 paywall
- [ ] 超 5 檔後：只能全數賣出、不能買入、不能部分賣
- [ ] 賣至合規後：恢復正常 Free 買賣（仍受 5 檔／3 帳戶／單市場限制）
- [ ] **恢復購買**（刪 App 重裝）
- [ ] 年訂方案購買路徑
