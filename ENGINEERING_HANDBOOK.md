...
flowchart TB
    subgraph GitHub["GitHub（程式碼 + 定時機器人）"]
        ...
        WF3[Daily Portfolio Snapshot<br/>每天 23:40]
    end
...
| 你的持股／現金／負債摘要 | `user_portfolio_state` | **App 交易後同步** | 給 23:40 腳本算走勢 |
| 每日淨資產走勢 | `user_daily_snapshots` | 每日 23:40 腳本 | 首頁走勢圖 |
...
> 這份摘要給每天 23:40 的 Python 腳本讀，用來算你的淨資產走勢。
...
| **每天 23:40** | [Daily Portfolio Snapshot](./.github/workflows/daily-portfolio-snapshot.yml) | 讀你的持股 + 股價 + 匯率 → 算淨資產 | Supabase `user_daily_snapshots` |
